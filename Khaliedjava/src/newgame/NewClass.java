         ...
         while(isGame == true){{
                          ...
                          String str[] = {"Red" , "Black" , "Blue" , "Yellow" , "Orange" , "Green"};
                           int arr[] = {5, 2, 1, 4, 6, 3 };
                            ...
                            //System.out.println("flaaaaaaaaaaaaaaaaaaaaaaaaaaag " + flag);
                            //System.out.println("3aaaaaa " + randomNumber);
                            //System.out.println("hiiiiiiiiiiiiiiiiiiii        " +str[randomNumber]);
                            //System.out.println("scoreeeeeeeeeeeeeeeeeee      " + score);
                            s = new frame(score , k);
                            ...
                            //randomNumber=rand.nextInt((5 - 0) + 1) + 0;
                            //frame so = new frame(score );
                            //so.paint(randomNumber);
                          if((p.x_pos>=b.x_pos-50 && p.x_pos<= b.x_pos+50) && (p.y_pos>=b.y_pos && p.y_pos<= b.y_pos+50)){
                                   ...
                                   //System.out.println("no " + randomNumber);
                                    ...
                                    //System.out.println("opaaaaaaaaaaaa" + my.get(0));
                                    int k = my.get(0);
